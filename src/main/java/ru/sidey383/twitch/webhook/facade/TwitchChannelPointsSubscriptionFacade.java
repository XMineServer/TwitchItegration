...
public class TwitchChannelPointsSubscriptionFacade {
    ...
    public ChannelPointsRewardRedemptionSubscribe createChannelPointsRedemptionWebhook(@NotNull Long userId) {
    ...
    public DataList<ChannelPointsRewardRedemptionSubscribe> getChannelPointsRedemptionWebhooks(@NotNull Long userId) {
    ...
    public DataList<ChannelPointsRewardRedemptionSubscribe> deleteChannelPointsRedemptionWebhook(@NotNull Long userId, String subscriptionId) {
